// app/produkty/markizy/page.tsx
import Image from "next/image";
import Link from "next/link";
import ProductHeader from "@/components/ProductHeader";
import ProductGallery from "@/components/ProductGallery";
import MarkizyExplainer from "../../../components/ProductExplainer/products/Markizy";
...
export default function MarkizyPage() {
  const data = MARKIZY_DATA;
    ...
    <main className="relative">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-12">
        ...
        <nav aria-label="Breadcrumb" className="mb-6 text-sm text-neutral-500">
          ...
          <span className="mx-2">/</span>
          <span aria-current="page" className="text-neutral-700">Markizy</span>
        </nav>
        ...
        <section className="grid gap-8 md:grid-cols-3">
          {/* Explainer span 2 colonne su desktop */}
          ...
          <aside className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-neutral-100 md:flex md:h-full md:flex-col">
            ...
            <p className="mt-2 text-neutral-600">
              Zadzwoń lub napisz — dobierzemy tkaninę, wymiary i sterowanie do Twojego tarasu/balkonu.
            </p>
