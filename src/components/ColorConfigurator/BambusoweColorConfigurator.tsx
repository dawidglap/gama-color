// src/components/Zaluzje/BambusoweColorConfigurator.tsx
'use client';

import React from 'react';
import { motion, AnimatePresence, cubicBezier, type Variants } from 'framer-motion';
import BambusoweSlatsPreview from '../ColorConfigurator/BambusoweSlatsPreview';
import { bambooSlatOptions, type BambooSlatOption } from '@/data/bambusowe';
...
export default function BambusoweColorConfigurator({
  title = 'Kolorystyka żaluzji bambusowych',
  subtitle = 'Wybierz wybarwienie lameli z naturalnym rysunkiem bambusa',
  ...
  const [slats, setSlats] = React.useState<BambooSlatOption>(bambooSlatOptions[0]);
  ...
  return (
    <section className="mt-10 space-y-8">
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        {/* pannello grande campione texture — con etykieta sopra */}
        <div
